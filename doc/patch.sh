...
cp $Fuse_newversion_HOME/manual_steps/manual_steps/bin/client $Fuse_HOME/bin

echo " #step2# cp the newversion client to " + $Fuse_newversion_HOME/bin
...
#6#
cp $Fuse_newversion_HOME/manual_steps/etc/org.apache.karaf.features.cfg $Fuse_HOME/etc
